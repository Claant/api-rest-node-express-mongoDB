...
export const requireToken = (req, res, next) => {
    ...
    if(!token) throw new Error('No existe el token en el header  Bearer'); // si token es undefined, es decir, si no se envio un token en el header de la peticion, se lanza un error indicando que no se proporciono un token.
